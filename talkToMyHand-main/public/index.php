...
<div class="container-fluid">
	...
	<img id="clue_image" src="images/capstone_logo.jpg" class="rounded bordered_div" alt="Clue image"/>
	</div>
	  ...
	  <div class="col-6 bordered_div container-fluid">
		  ...
		  <tbody>
			<tr>
			  <th class="table-light number" scope="row">1</th>
			  <td class="table-light answer fs-2"></td>
			</tr>
			<tr>
			  <th class="table-light number" scope="row">2</th>
			  <td class="table-light answer fs-2"></td>
			</tr>
			<tr>
			  <th class="table-light number" scope="row">3</th>
			  <td class="table-light answer fs-2"></td>
			</tr>
			<tr>
			  <th class="table-light number" scope="row">4</th>
			  <td class="table-light answer fs-2"></td>
			</tr>
			<tr>
			  <th class="table-light number" scope="row">5</th>
			  <td class="table-light answer fs-2"></td>
			</tr>
		  </tbody>
		</table>
